...
public class Diplomacy {
     ...
     * @param p_GameEngine
     */
    public Diplomacy(String p_CountryNameTo, int p_NumberOfArmies, GameEngine p_GameEngine) {
    ...
    public void execute() {
        ...
        if (!l_CurrentPlayer.hasCard(new Card("Diplomacy"))) {// check if player has the Bomb card
